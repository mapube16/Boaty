...
export const Benefits = () => {
    return (
        <section id="beneficios" className="py-32 bg-white relative overflow-hidden">
            <div className="container mx-auto max-w-7xl px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                    <motion.div
                        ...
                        className="max-w-2xl"
                    >
                        <span className="text-orange font-bold text-[10px] uppercase tracking-[0.4em] mb-4 block">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {benefits.map((benefit, i) => (
                        <motion.div
                            ...
                            className="group relative p-10 rounded-[40px] border border-cream hover:border-orange/20 transition-all duration-500 bg-cream-light/30 hover:bg-white hover:shadow-premium"
                        >
                            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:bg-orange transition-colors duration-500">
                            ...
                            {/* Accent Dot */}
                            <div className="absolute top-10 right-10 w-1.5 h-1.5 rounded-full bg-cream group-hover:bg-orange transition-colors" />
                        </motion.div>
                    ))}
                </div>
            </div>
            ...
            <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-orange/5 rounded-full blur-[100px] pointer-events-none" />
        </section>
    );
};
